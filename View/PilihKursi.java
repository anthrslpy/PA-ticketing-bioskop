...
//        }
    ...
    private boolean isKursiTerpakai(String idJadwal, String nomorKursi) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(KURSI_FILE))) {
            ...
            JOptionPane.showMessageDialog(this, "Gagal membaca data kursi", "Error", JOptionPane.ERROR_MESSAGE);
        }
        return false;
    }    
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {                    
                    Film film = loadFilmFromFile("dataFilm.txt", "0101");
                    if (film != null) {
                        new PilihKursi(idJadwal, film, currentStudio, user).setVisible(true);
                    } else {
