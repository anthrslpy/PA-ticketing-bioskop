...
public class PilihStudio extends javax.swing.JFrame {
    private static ViewFilm viewFilm;
    private static Film selectedFilm;
    
    public PilihStudio(ViewFilm viewFilm, Film selectedFilm) {
        initComponents();
    ...
    private void btnTime1Studio1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTime1Studio1ActionPerformed
        PilihKursi pilihKursi = new PilihKursi(this, selectedFilm);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PilihStudio(viewFilm, selectedFilm).setVisible(true);
            }
        });
    }
