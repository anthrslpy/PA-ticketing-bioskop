...
public class Register extends javax.swing.JFrame {
    ...
    private void prosesRegistrasi() {
        ...
        if(valid){
            if (role.equals("CUSTOMER")) {
                ...
                userBaru = new Admin(generateId(), username, email, password, code); 
                try (BufferedWriter writer = new BufferedWriter(new FileWriter("UsersData.txt", true))) {                
                    writer.write(String.format("%s,%s,%s,%s,%s,%s\n", id, email, username, password, code, role));                            
                } catch (IOException e) {
                    JOptionPane.showMessageDialog(register, "Failed to save your data!");
                } 
            }
    ...
    private void loadDataPengguna() {        
        try {
            try (BufferedReader reader = new BufferedReader(new FileReader("UsersData.txt"))) {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    if (role.equalsIgnoreCase("CUSTOMER")) {
                        ...
                        dataPengguna.add(p);
                        System.out.println("Data berhasil di add");
            ...
            JOptionPane.showMessageDialog(register, "Failed to load inventory.");
        }
    }
    ...
    private void initComponents() {
        ...
        lblPhone.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        ...
        comboRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CUSTOMER", "ADMIN" }));
        ...
        lblCode.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(comboRole, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(fieldCode, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(131, 131, 131))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void comboRoleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboRoleActionPerformed
        ...
        if("ADMIN".equals(selectedRole)) {
            ...
            fieldPhone.setVisible(false);
            lblPhone.setVisible(false);
            if(!code.substring(0, 3).equals("NIP")){
                JOptionPane.showMessageDialog(this, "Code is wrong!", "Error", JOptionPane.ERROR_MESSAGE);
                valid = false;            
            }
        } else {
    ...
    private static javax.swing.JComboBox<String> comboRole;
